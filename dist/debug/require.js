  ...
  _.extend(Collection.prototype, Events, {
    ...
    set: function(models, options) {
      ...
      for (i = 0, l = toAdd.length; i < l; i++) {
        // console.log("AA:"+toAdd.length); //GME 
...
define("assetsvendor/jquery-ui-1.10.3.custom/js/jquery-ui-1.10.3.custom.min", function(){});

define('views/DateSelectorView',[
  // The App
  'app',
  // Dependencies
...
define("assetsvendor/chosen/chosen/chosen.jquery.min", function(){});

define('views/tournament/SelectorView',[
  // The App
  'app',
  // Dependencies
  'jquery', 'backbone', 'lodash',
...
define('views/tournament/ListView',[
  // The App
  'app',
  // Dependencies
  'jquery', 'backbone', 'lodash',
...
define('collections/Tournaments',[
  // The app
  'app',
  // Library Dependencies
  'jquery', 'lodash', 'backbone',
